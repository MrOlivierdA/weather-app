...
function showPosition(position) {
  ...
  var APIkey = "549c3c5fdc151bb620b4b5ca3c6cdb72";
  var uvWeatherURL =
  ...
  var localWeatherURL =
    ...
    "&lon=" +
    lon +
    "&units=metric&appid=549c3c5fdc151bb620b4b5ca3c6cdb72";
  ...
  function localWeather() {
    $.ajax({
      ...
      var localIcon =
        ...
        localResponse.list[0].weather[0].icon +
        ".png";
      ...
      var localFiveIconOne =
        "https://openweathermap.org/img/w/" +
        localResponse.list[1].weather[0].icon +
        ".png";
      ...
      var localFiveIconTwo =
        "https://openweathermap.org/img/w/" +
        localResponse.list[6].weather[0].icon +
        ".png";
      ...
      var localFiveIconThree =
        "https://openweathermap.org/img/w/" +
        localResponse.list[14].weather[0].icon +
        ".png";
      ...
      var localFiveIconFour =
        "https://openweathermap.org/img/w/" +
        localResponse.list[22].weather[0].icon +
        ".png";
      ...
      var localFiveIconFive =
        "https://openweathermap.org/img/w/" +
        localResponse.list[30].weather[0].icon +
        ".png";
...
function citySearch() {
  ...
  $.ajax({
    ...
    var selectIcon =
      "https://openweathermap.org/img/w/" +
      response2.list[0].weather[0].icon +
      ".png";
    ...
    var cityFiveIconTwo =
      "https://openweathermap.org/img/w/" +
      response2.list[1].weather[0].icon +
      ".png";
    ...
    // Block 3
    var cityFiveIconThree =
      "https://openweathermap.org/img/w/" +
      response2.list[2].weather[0].icon +
      ".png";
    ...
    // Block 4
    var cityFiveIconFour =
      "https://openweathermap.org/img/w/" +
      response2.list[3].weather[0].icon +
      ".png";
    ...
    // Block 5
    var cityFiveIconFive =
      "https://openweathermap.org/img/w/" +
      response2.list[4].weather[0].icon +
      ".png";
